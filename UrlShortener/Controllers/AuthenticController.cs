...
namespace UrlShortener.Controllers
{
    ...
    public class AuthenticController : ControllerBase
    {
        ...
        public AuthenticController(IConfiguration config, UserServices userService)
        {
        ...
        public IActionResult Autenticar(AuthenticationDto authenticationRequestBody) //Enviamos como parámetro la clase que creamos arriba
        {
